  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[440px]">
        <div
          className={`relative z-20 mb-3 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
        ...
        >
          ...
          {NODES.map((n, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-[11px] font-bold transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${
                    active
                ...
                <p
                  className={`mt-1.5 max-w-[72px] text-center text-[10px] font-semibold leading-tight tracking-[-0.01em] transition-colors duration-500 ${
          ...
          >
            <div className="relative h-12 w-12 overflow-hidden rounded-full ring-[3px] ring-[#fff8ee] shadow-[0_12px_28px_rgba(26,26,26,0.28)]">
              <Image src="/people/ciara.jpg" alt="" fill className="object-cover" sizes="48px" />
            </div>
