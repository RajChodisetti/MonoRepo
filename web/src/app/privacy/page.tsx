...
export const metadata: Metadata = {
  ...
  description: "How Tuvi Solutions collects, uses, protects, and shares information, including data processed through Google APIs.",
  ...
  return (
    ...
    >
      <LegalSection title="1. Who we are and what this policy covers">
        <p>
          Tuvi Solutions (&quot;Tuvi&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) builds websites,
      ...
      <LegalSection title="2. Information we collect">
        <LegalList>
          ...
          <li>
            <strong className="text-ink">Business outreach information:</strong> business
          ...
          <li>
            ...
            and security logs may include an IP address, browser or device details,
            requested pages, timestamps, and error information.
          </li>
        </LegalList>
        <p>
      ...
      <LegalSection title="3. Google API data and Gmail access">
        ...
        <LegalList>
          ...
          <li>
            tuvi does not request permission to read or download inbox messages,
            contacts, attachments, message history, Google Drive files, or other Google
            account content.
          </li>
          <li>
        ...
        <p>
          Tuvi&apos;s use and transfer of information received from Google APIs adheres to the{" "}
          <a
      ...
      <LegalSection title="5. When we share information">
        <p>
          ...
          as with hosting, database, communications, voice, and email providers acting
          for us. Google receives the data required to authenticate the authorized
          mailbox and send messages through Gmail. We may also disclose information
          when required by law, to protect rights or safety, or as part of a business
      ...
      <LegalSection title="7. Your choices and rights">
        <LegalList>
          <li>Use the unsubscribe link in an outreach email to stop future marketing messages to that address.</li>
          <li>Revoke Tuvi&apos;s Google access from the security settings in your Google Account.</li>
          <li>
