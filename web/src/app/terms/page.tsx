...
export const metadata: Metadata = {
  ...
  description: "Terms governing use of the Tuvi Solutions website, consultations, voice assistant, and connected services.",
  ...
  return (
    ...
    >
      <LegalSection title="1. Acceptance of these terms">
        <p>
          By accessing or using the Tuvi Solutions website or its features, you agree
          to these Terms of Service (&quot;Terms&quot;). If you use the services for an
          organization, you confirm that you have authority to accept these Terms for
      ...
      <LegalSection title="3. Consultations, callbacks, and AI interactions">
        <LegalList>
          ...
          <li>
            Consultation availability and confirmed bookings are managed in Tuvi&apos;s
            database. Communications providers may affect callback or confirmation
            delivery, but Tuvi does not currently consult or update an external calendar.
          </li>
        </LegalList>
      </LegalSection>
      ...
      <LegalSection title="10. Disclaimers">
        <p>
          ...
          features are provided &quot;as is&quot; and &quot;as available&quot; without
          implied guarantees of fitness, merchantability, non-infringement, or a
          particular business outcome. Nothing in these Terms excludes a guarantee,
          warranty, or consumer right that cannot legally be excluded.
        </p>
      </LegalSection>
