-- Rollback restores the previous enrollment function but keeps the sender
-- disabled. Existing enrollment rows are preserved for operator inspection.
...
SET status = 'cancelled',
    ...
    last_error = 'Cancelled by migration 50 rollback; explicitly enable outreach after verification.',
    updated_at = now()
