...
Canonical and personal-mirror history includes the reviewed PR #3 release; the original dirty worktree remains preserved and no committed branch contains unique work outside `master`.
