...
export default function BookConsultationForm() {
  ...
  if (success) {
    return (
      <div className="rounded-3xl border border-border bg-bg-elevated/90 p-8 text-center shadow-2xl backdrop-blur-xl md:p-10">
        ...
        <div className="mt-6 space-y-3 rounded-xl border border-border bg-surface px-4 py-4 text-left text-sm">
        ...
        <div className="mt-6 flex flex-col gap-3">
          {success.calendar_link ? (
            <a
              ...
              className="rounded-full bg-ink px-6 py-3 text-sm font-semibold text-[#fffef8] transition-colors hover:bg-primary"
            >
          ...
          <Link
            href="/"
            className="rounded-full border border-border px-6 py-3 text-sm font-medium text-muted transition-colors hover:border-primary hover:text-text"
          >
            Back to home
          </Link>
        </div>
  ...
  return (
    <div className="relative rounded-3xl border border-border bg-bg-elevated/90 p-6 shadow-2xl backdrop-blur-xl md:p-8">
      {submitting && (
      ...
      {selected && (
        <form onSubmit={(e) => void handleSubmit(e)} className="mt-6 border-t border-border pt-6">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <label className="block">
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-xl border border-border bg-surface px-4 py-3 text-sm text-text outline-none transition focus:border-primary/60"
          ...
          <button
            ...
            className="mt-5 w-full rounded-full bg-ink px-6 py-3.5 text-sm font-semibold text-[#fffef8] transition-colors hover:bg-primary disabled:cursor-not-allowed disabled:opacity-50"
          >
            Confirm booking
          </button>
        </form>
