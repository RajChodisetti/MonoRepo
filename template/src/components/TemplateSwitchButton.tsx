...
export default function TemplateSwitchButton({
  ...
  if (mode === "mobile") {
    ...
    const accentClass =
      variant === "aurora" ? "text-cyan-300" : variant === "elysian" ? "text-[#D4AF37]" : "text-[#d3a45d]";
  ...
  const className =
    variant === "aurora"
      ...
      : variant === "elysian"
        ? "hidden rounded-full border border-[rgba(212,175,55,0.35)] px-4 py-2 text-xs font-medium text-[#D4AF37] transition hover:border-[#D4AF37] hover:bg-[rgba(212,175,55,0.08)] min-[901px]:inline-flex"
