...
SQL migrations: backend/migrations, including durable scrape/OCR/outreach workflow, restaurant-media, and demo-ready backfill migrations through deployed 000032. Integration test slot: backend/tests.
...
Migration 000032 moved 22 existing `lead` restaurants with draft/published demo records to `demo_ready`; production now has demo_ready=22 and lead=922.
```
