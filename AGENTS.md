...
SQL migrations: backend/migrations, including durable scrape/OCR/outreach workflow and restaurant-media migrations through deployed 000031. Integration test slot: backend/tests.
